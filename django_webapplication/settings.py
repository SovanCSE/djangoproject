"""
Django settings for django_webapplication project.
...
SECRET_KEY = '^d_h#f=1l5$)ocdwkkc#hi2bx&h-7deiqa&syog%f3(321#v#a'
...
ROOT_URLCONF = 'django_webapplication.urls'
...
WSGI_APPLICATION = 'django_webapplication.wsgi.application'
